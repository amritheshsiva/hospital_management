        ...
        <div>
            ...
            <div className='container-fluid' style={{ minHeight: "100vh" }}>
                ...
                <div className="d-flex justify-content-center mt-4">
                    <div className="d-flex align-items-center w-100 shadow-sm rounded-pill overflow-hidden"
                    style={{ maxWidth: "1000px", background: "#ffffff" }}>
                        ...
                        480 272 480C157.1 480 64 386.9 64 272C64 157.1 157.1 64 272 64C386.9 64 480 157.1 480 272zM272 416C351.5 416 416 351.5 416 272C416 192.5 351.5 128 272 128C192.5 128 128 192.5 128 272C128 351.5 192.5 416 272 416z"/>
                            ...
                            <input type="text" className="form-control border-0 bg-transparent" placeholder="Search appointments..." onChange={(e)=>setSearchDoctor(e.target.value)}/>
                        </div>

                        <div style={{ width: "1px", height: "30px", background: "#c8bcbc" }}></div>
                ...
                <div className='row px-3 justify-content-center'>
                    ...
                    <div className='col-md-10 mt-4'key={appt.id}>
                        <div className='card border-0 p-3 shadow-sm' style={{ borderRadius:'15px' }}>
                            <div className='d-flex align-items-center justify-content-between flex-wrap'>
                                <div className='d-flex align-items-center'>
                                    ...
                                    />
                                    <div>
                                        <p className='mb-1 text-muted small'>{appt.Date} • {appt.time_slot}</p>
